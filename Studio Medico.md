...
- una prescrizione è associata a una visita e a un fattoria
...
- `query Python3.py` → mostra l'elenco dei comandi disponibili
...
- `python3 query.py fattoria-paziente <codice_paziente>` → mostra i fattoria presi da un paziente
...
- `python3 query.py fattoriaco-pazienti` → mostra quali pazienti hanno risovuto ciascun fattoria
...
- Un **Medico** condurre più **Visitare** (1:N)
